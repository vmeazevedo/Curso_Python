...
face_cascade = cv2.CascadeClassifier('C:\\Users\\pqcir\\Documents\\Programação\\Python\\Códigos\\detect\\haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('C:\\Users\\pqcir\\Documents\\Programação\\Python\\Códigos\\detect\\haarcascade_eye.xml')
